...
function AuthSidePanel({ mode }: { mode: 'login' | 'signup' }) {
  return (
    <div className="hidden lg:flex lg:flex-1 relative overflow-hidden items-center justify-center p-12">
      {/* Background Image */}
      <div 
        className="absolute inset-0 bg-cover bg-center" 
        style={{ backgroundImage: 'url(/auth-bg.jpg)' }} 
      />
      <div className="absolute inset-0 bg-[#0d0e14]/80" />
      
      {/* Blurred color blobs */}
      <div className="absolute -top-20 -left-20 w-80 h-80 rounded-full bg-primary-500/[0.15] blur-[100px] animate-aurora" />
      <div className="absolute bottom-10 right-10 w-60 h-60 rounded-full bg-neon-blue/[0.12] blur-[100px] animate-aurora-2" />
      ...
      <div className="relative z-10 max-w-sm text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {[
            ...
            <span
              key={text}
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-xs font-medium text-white"
            >
        ...
        {/* Testimonial */}
        <div className="mt-12 p-6 rounded-2xl bg-white/5 border border-white/10 text-left backdrop-blur-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400">Frequent traveler</p>
            </div>
          </div>
        </div>
      </div>
...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh)] text-white bg-[#0d0e14]">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[400px] animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="email" className="label text-gray-300">Email address</label>
              <input
                id="email"
                type="email"
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                className="input-field !bg-white/5 !border-white/10 !text-white focus:!border-primary-500 placeholder-gray-500"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="input-field !bg-white/5 !border-white/10 !text-white focus:!border-primary-500 placeholder-gray-500 pr-12"
                  placeholder="••••••••"
                  required
            ...
            <details className="group">
              <summary className="text-xs text-gray-400 font-medium cursor-pointer hover:text-white transition-colors flex items-center gap-1">
                <span className="w-1 h-1 rounded-full bg-accent-500 mr-1" />
                Demo accounts available
              </summary>
              <div className="mt-2 p-3 rounded-xl bg-white/5 shadow-sm border border-white/10 text-[11px] text-gray-300 space-y-1 font-mono animate-fade-in">
                <p><span className="text-gray-400 font-sans font-medium">Admin:</span> admin@carrental.com / admin123</p>
                <p><span className="text-gray-400 font-sans font-medium">Owner:</span> owner1@carrental.com / owner123</p>
                <p><span className="text-gray-400 font-sans font-medium">User:</span> user1@carrental.com / user123</p>
              </div>
            </details>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[400px] animate-fade-in">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm mt-2">Start your journey with DriveX</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="name" className="label text-gray-300">Full name</label>
              <input
                id="name"
                type="text"
                value={name}
            ...
            <div>
              <label htmlFor="signup-email" className="label text-gray-300">Email address</label>
              <input
                id="signup-email"
                type="email"
                value={email}
            ...
            <div>
              <label htmlFor="signup-password" className="label text-gray-300">Password</label>
              <div className="relative">
                <input
                  id="signup-password"
                  type={showPw ? 'text' : 'password'}
            ...
            <div>
              <label className="label text-gray-300">I want to</label>
