          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="card p-4 animate-pulse">
              <div className="flex gap-3">
                <div className="w-10 h-10 bg-white shadow-sm rounded-xl flex-shrink-0" />
                <div className="flex-1 space-y-2">
                  <div className="h-4 bg-white shadow-sm rounded w-3/4" />
                  <div className="h-3 bg-white shadow-sm rounded w-1/2" />
                </div>
              </div>
            </div>
          ))}
